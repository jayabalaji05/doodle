...
section.promo section offset-header{
background: url(http://www.pageresource.com/wallpapers/wallpaper/texture-ground-back-white-textured-textureimages_1175896.jpg) no-repeat center center fixed; 
...
<body data-spy="scroll">
    <section id="promo" class="promo section offset-header">
        ...
        <br>
            <h2 class="title">Suggestion<span class="highlight">CART</span></h2>
            <p class="intro">Let the Internet Suggest the Product for your Situation</p>
            <div class="btns">
                <a class="btn btn-primary btn-lg" href="wedding_suggestion">Weddings</a>
                <a class="btn btn-primary btn-lg" href="under_construction">Birthdays</a>
                <a class="btn btn-primary btn-lg" href="under_construction">Surprises</a>
            </div>
            <br><br>
        </div><!--//container-->
    </section><!--//promo-->	    
