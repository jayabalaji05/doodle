...
<c:forEach items="${productList}" var="product">
										<div class="col-sm-4">
											<div class="thumbnail">
												<!--span class="e-label"><div>Sale</div></span-->
												<span class="service-link text-center">
													<img class="img-responsive" src="G:\products/${product.id}.jpg" style="width:200px;height:200px"alt=""/>
												</span>
												<div class="caption">
													...
													<div><a href="product_description/${product.id}" class="btn btn-default" role="button">View</a></div>
												</div>
											</div>
										</div>
									</c:forEach>
